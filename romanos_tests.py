...
class Roman_to_Integer_test(unittest.TestCase):
...
class Integer_to_Roman_test(unittest.TestCase):
    def test_traduccion_grupos_de_valores_simples(self):
    ...
    def test_traduccion_grupos_de_valores_complejos_unidades(self):
    ...
    def tests_entero_a_romano_(self):
